...
export default function MedicalReimbursementPage() {
  ...
  const createCase = () => {
    ...
    setOpen(false);
    setActiveMrCaseId(next.mrId);
    window.location.href = '/reimbursement/medical/workspace';
  };
        ...
        <section className={`${styles.page} mt-4`}>
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            {[...cases]
              ...
              .slice(0, 7)
              .map((c) => (
                <Link href="/reimbursement/medical/workspace" onClick={() => setActiveMrCaseId(c.mrId)} key={c.mrId} className={styles.bookCard}>
              ...
              return (
                <article key={c.mrId} className={styles.bookCard}>
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    <div>
                      <Link href="/reimbursement/medical/workspace" onClick={() => setActiveMrCaseId(c.mrId)} className="font-semibold text-indigo-900">
                        {c.mrNo}
                      </Link>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2 text-xs">
                    <Link className="rounded border border-indigo-300 px-2 py-1" href="/reimbursement/medical/workspace" onClick={() => setActiveMrCaseId(c.mrId)}>Continue</Link>
                    <Link className="rounded border border-slate-300 px-2 py-1" href="/reimbursement/medical/workspace#annexures" onClick={() => setActiveMrCaseId(c.mrId)}>Add Bill/Doc</Link>
                    <Link className="rounded border border-slate-300 px-2 py-1" href="/reimbursement/medical/workspace#advance" onClick={() => setActiveMrCaseId(c.mrId)}>Add Advance</Link>
