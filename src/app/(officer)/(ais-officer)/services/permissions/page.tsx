  ...
  return (
    <div className="relative mb-3 overflow-hidden rounded-xl border border-indigo-200 bg-gradient-to-r from-indigo-900 via-indigo-500 to-indigo-900 dark:border-neutral-700 dark:bg-none dark:bg-neutral-800">
      ...
      >
        ...
        {/* Links (not used here, but kept for parity) */}
        {links.length > 0 && (
          <ul
            ref={listRef}
  ...
  return (
    <>
      <ServicesCard
        ...
        imageSrc="/images/services/meeting.svg"
        navigateTo="#"
      />

      <ServicesCard
        title="Workshops"
        imageSrc="/images/services/workshop.svg"
        navigateTo="#"
      />
      ...
      <ServicesCard
        ...
        imageSrc="/images/services/foreign-study.svg"
        navigateTo="#"
      />
